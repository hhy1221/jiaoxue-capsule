...
// 追加问答（8条新）
const Q2: CommunityQuestion[] = [
  { id:'q13',title:'西北干旱地区怎么开展自然观察课？',status:'open', content:'我们支教地在宁夏固原，属于黄土高原，植被很少。想做自然观察课但实在没什么可看的……有没有适合干旱地区的自然教育方案？', author:A2.dapeng,subject:'science',gradeRange:'3-6年级',region:'西北', tags:['自然观察','干旱地区','黄土高原','户外教学'], answers:[], views:67, likes:5,createdAt:'2026-07-30'},
  { id:'q14',title:'少数民族地区语言不通怎么教语文？',status:'answered', content:'在云南西双版纳支教，很多傣族孩子汉语水平很低，上课听不懂我在说什么。但是按大纲必须教语文……怎么办？', author:A2.xueli,subject:'chinese',gradeRange:'1-3年级',region:'西南', tags:['少数民族','语言障碍','双语教学','语文启蒙'], answers:[{ id:'a14',content:'不要硬教课本！先从"生活汉语"开始。\n\n1. 每天第一节用10分钟做"今天的话题"——用实物、图片、动作配合简单的汉语句子\n2. 让孩子们当你的傣语老师——你学一句傣语，他们学一句汉语，双向学习建立信任\n3. 用他们的民间故事——讲一个傣族故事的中文版，他们感兴趣自然想听懂\n4. 图画日记：不求字多，画一幅图配一个句子\n\n我最初在凉山彝区支教也遇到过同样的问题，一个月后孩子们能用汉语进行简单对话了。关键不是教课本，是建桥梁。', author:AUTHORS.ma,likes:19,isAccepted:true,createdAt:'2026-07-30'}], views:89,likes:11,createdAt:'2026-07-30'},
  { id:'q15',title:'高海拔地区（3000米+）支教注意什么？',status:'open', content:'下个月去青海玉树的一个支教点，海拔3800米。队里有几个人是平原长大的。求高原支教的经验和注意事项！', author:{ id:'v9',name:'追光者支教队-小吴',avatar:'吴',role:'volunteer' as const,verified:true,badge:'追光者支教队',teamName:'追光者支教队',location:'青海玉树'},subject:'general',gradeRange:'1-6年级',region:'西北', tags:['高海拔','高原反应','青海','安全'], answers:[], views:134,likes:15,createdAt:'2026-07-30'},
  { id:'q16',title:'支教课堂上孩子玩手机怎么办？没收？不管？',status:'open', content:'我们支教地竟然有几个孩子带了智能手机来上课（父母淘汰的旧手机）。上课在桌子底下刷短视频。没收怕伤自尊，不管又影响课堂。怎么处理？', author:A2.ting,subject:'general',gradeRange:'3-6年级',region:'西南', tags:['手机管理','课堂纪律','电子产品','留守儿童'], answers:[], views:78,likes:7,createdAt:'2026-07-31'},
  { id:'q17',title:'英语发音不准的老师（我）怎么教孩子？',status:'answered', content:'我高考英语还不错，但发音确实不太好（中式口音比较重）。我怕教坏了孩子的基础发音。有没有不需要标准发音的英语教学方法？', author:A2.fang,subject:'english',gradeRange:'3-6年级',region:'西北', tags:['英语教学','发音','非母语教师','替代方案'], answers:[{ id:'a17',content:'发音不标准完全不影响做一个好英语老师！\n\n1. 重点教阅读和写作——这些不需要完美发音\n2. 用英文儿歌/动画片做听力材料——让孩子听原声\n3. 英语绘本朗读——买几本有声书（扫二维码听），你只要引导讨论就行\n4. "英语戏剧课"——孩子们演简单的英文短剧，重点在表达而不是发音\n5. 诚实告诉孩子："老师的发音不太好，我们一起来学标准的"——这本身就是最好的教育：学习是一辈子的事，不用完美才能开始\n\n不要因为发音不好就不教英语。乡村孩子最缺的不是标准发音，是有人告诉他们"英语是一个可以打开的世界"。', author:AUTHORS.ma,likes:31,isAccepted:true,createdAt:'2026-07-31'}], views:112,likes:19,createdAt:'2026-07-31'},
  { id:'q18',title:'怎么判断一个支教队是否靠谱？求鉴别方法',status:'answered', content:'我想参加暑期支教但在网上看到好多"支教旅游""支教镀金"的负面新闻。怎么判断一个支教队到底是认真做事的还是去拍照打卡的？', author:{ id:'p4',name:'想支教的阿明',avatar:'明',role:'public' as const,verified:false,badge:'大三学生',location:'上海'},subject:'general',gradeRange:'不限',region:'不限', tags:['支教队选择','鉴别','支教质量','避坑指南'], answers:[{ id:'a18',content:'作为做了7年支教的过来人，给你几个硬指标：\n\n✅ 靠谱支教队的特征：\n1. 有固定支教点，至少连续3年以上在同一所学校\n2. 有出发前培训（至少3次以上，不是开个会就算培训了）\n3. 支教时长至少10天以上（3-5天的基本都是旅游）\n4. 有往届成员的公开分享（看他们结营后还和学校保持联系吗）\n5. 经费透明（交多少钱、花在哪里都公开）\n\n❌ 避雷信号：\n1. 宣传语大量使用"改变命运""拯救"这类词\n2. 支教照片以志愿者自拍为主，孩子只是背景板\n3. 没有教学计划，说"到了再安排"\n4. 报名费高但说不清楚用在哪\n5. 拒绝提供往届成员联系方式\n\n一个简单测试：问他们"如果今年没有新队员，你们还去吗？"——如果回答"当然去"，那是真支教。', author:AUTHORS.wang,likes:89,isAccepted:true,createdAt:'2026-07-31'}], views:567,likes:102,createdAt:'2026-07-31'},
  { id:'q19',title:'特殊儿童在支教班里怎么照顾？有个孩子有轻度自闭',status:'open', content:'班上有个8岁男孩，家长说医院诊断为轻度自闭。他不跟其他孩子玩，但特别喜欢画画，可以一个人画一整天。我想帮他但不知道怎么帮。', author:A2.ting,subject:'psychology',gradeRange:'2年级',region:'西南', tags:['特殊教育','自闭症','融合教育','美术治疗'], answers:[], views:45,likes:8,createdAt:'2026-08-01'},
  { id:'q20',title:'支教队内部矛盾：备课组长和宣传组长吵起来了…怎么办',status:'open', content:'队里备课组长觉得宣传组花太多时间拍照拍视频，影响了课堂节奏。宣传组长说"不记录怎么展示支教成果"。两人越吵越凶……求调解经验。', author:A2.dapeng,subject:'general',gradeRange:'不限',region:'西北', tags:['团队管理','内部矛盾','沟通','支教运营'], answers:[], views:92,likes:4,createdAt:'2026-08-01'},
]
QUESTIONS.push(...Q2)

// 追加故事（8篇新）
const S2: CommunityStory[] = [
  { id:'s9',title:'玉树高原上的第一堂天文课',likes:76, content:'在海拔3800米的青海玉树，晚上带着孩子们躺在操场上用肉眼认星座。城里孩子要看天文馆，这里的孩子什么都不需要——抬头就是整个银河。\n\n一个男孩问："老师，星星上有人吗？"\n\n我说："也许没有人，但有无数个像我们一样在仰望星空的生命。"\n\n他说："那他们也是在看我们吗？"\n\n——这是我在大学四年里从没在课本上学到过的哲学问题。', author:A2.dapeng,images:['🌟'],teamName:'筑梦支教团',location:'青海玉树', tags:['天文','高原','星空','哲学'], comments:[],createdAt:'2026-07-30'},
  { id:'s10',title:'和傣族孩子学做"毫崩"（傣族年糕）',likes:52, content:'手工课那天，班里傣族孩子们的奶奶们主动来到学校教大家做"毫崩"——一种用糯米和芭蕉叶包的传统食物。\n\n整个教室变成了厨房。孩子们分组：有的洗芭蕉叶、有的淘米、有的切配料。最后每个人带一个回家。\n\n这比我任何一节课都更像教育。', author:A2.xueli,images:['🍚'],teamName:'彩云之南志愿队',location:'云南西双版纳', tags:['傣族文化','手工课','家校互动','传统文化'], comments:[],createdAt:'2026-07-31'},
  { id:'s11',title:'"老师，这是我用一个月攒的钱买的"',likes:133, content:'结营前一天，一个叫阿木的彝族男孩塞给我一个塑料袋。打开一看，是一支崭新的钢笔，标价18元。\n\n后来从班主任那里知道：他每天上学走5公里山路，中午在学校吃免费午餐，把家里每天给的2元零花钱攒了一个月。\n\n18元对一个山区孩子意味着什么？30天的期待，60里山路。\n\n那支钢笔现在还放在我的书桌上。我没有用过一次——我怕用完墨水，就什么都没有了。', author:A2.ting,images:['🖊️'],teamName:'阳光支教队',location:'四川美姑', tags:['彝族','学生礼物','感动','贫困'], comments:[{ id:'sc21',content:'看哭了。这些孩子给你的东西比任何东西都重。',author:AUTHORS.zhao,createdAt:'2026-08-01'}],createdAt:'2026-08-01'},
  { id:'s12',title:'用一部老式胶片相机记录下的支教12天',likes:98, content:'带去了一台理光胶片相机（我爷爷的旧物）。一卷36张，每天只拍3张。这意味着每一帧都要慎重选择——不能像手机那样随便按。\n\n第1天：大巴驶入山路的扬尘。第5天：女孩们围在一起编辫子。第8天：全班在黑板前的大合影。第12天：空教室，只剩下黑板上孩子们写的"再见"。\n\n胶卷洗出来的时候我哭了。不是因为照片有多好——是因为那36帧里，没有一张是我自己的自拍。每一张都是他们。\n\n（图为第5天女孩们编辫子的照片）', author:A2.fang,images:['📷'],teamName:'青苗助学计划',location:'甘肃天水', tags:['胶片摄影','记录','离别','12天'], comments:[],createdAt:'2026-08-01'},
  { id:'s13',title:'"老师，你能教我写自己的名字吗？"',likes:188, content:'支教第3天才发现班里有个女孩不认识自己的名字。不是不会写——是根本不认识。来报名是邻居帮忙填的信息表，她的名字叫"阿呷莫"，但她看到这三个字和看到"天空"没有区别。\n\n我花了整整一节课教她。"这是阿，像一个小房子。这是呷，左边是一个口，右边是一个甲——就是你今天穿的衣服上那个纽扣的形状。这是莫，上面是草，中间是太阳，下面是大——太阳照在大地上，就是莫。"\n\n她说："老师，这个名字真好看。"\n\n——那是我第一次，让她看见了自己的名字。', author:A2.ting,images:['✍️'],teamName:'阳光支教队',location:'四川美姑', tags:['识字','彝族','名字','文盲'], comments:[{ id:'sc22',content:'让她看见了自己的名字——这句话太有力量了',author:AUTHORS.zhao,createdAt:'2026-08-02'},{ id:'sc23',content:'可以用象形字教学！每个字的形状都有故事，比死记硬背有效一万倍。',author:AUTHORS.yang,createdAt:'2026-08-02'}],createdAt:'2026-08-02'},
  { id:'s14',title:'我们不是来"帮助"的——我们是来"学习"的',likes:67, content:'支教结束后很多人问我："你去支教了，帮助了多少孩子？"\n\n我回答不上来。因为我越来越不确定，到底是谁"帮助"了谁。\n\n是孩子教我怎么用树叶吹出鸟叫声。\n是一个老奶奶塞给我她种的核桃说"老师辛苦了"。\n是一个11岁男孩告诉我"读书不是为了离开山里，是为了让山里变得更好"。\n\n他们教会我的，远比我教给他们的多。\n\n所以如果有人再问"你们帮助了多少孩子"，我会说："我们没有帮助任何人。我们只是走了一趟山路，然后成为了比昨天好一点点的人。"', author:A2.xueli,images:['🌿'],teamName:'彩云之南志愿队',location:'云南西双版纳', tags:['支教反思','双向成长','公益理念','初心'], comments:[],createdAt:'2026-08-02'},
  { id:'s15',title:'一年后，收到了支教学生的来信',likes:215, content:'支教结束一周年那天，收到了支教学校班主任寄来的包裹。里面有7封信，是当时我带的那班的孩子们写的。\n\n一封封打开：\n- "老师我期末考试数学考了98分，全班第一"（那个当初说"我最讨厌数学"的男孩）\n- "老师我学会用电脑了，给你发了一封电子邮件"（然而并没有收到邮件，他可能还不会用）\n- "老师你说要回来看我们，你什么时候回来"（这封信没有署名，但我知道是谁写的——那个最安静的女孩）\n\n支教结束了365天。但好像从来没有真正离开过。', author:AUTHORS.han,images:['✉️'],teamName:'凡星支教队',location:'四川筠连', tags:['一年后','学生来信','成长','联结'], comments:[{ id:'sc24',content:'我也收到了！！去年支教的孩子们给我寄了明信片，哭了一下午。',author:A2.xueli,createdAt:'2026-08-03'},{ id:'sc25',content:'证明你们做对了。真正的支教影响是长期的。',author:AUTHORS.wang,createdAt:'2026-08-03'}],createdAt:'2026-08-03'},
  { id:'s16',title:'乡村小学的第一场"科技节"',likes:104, content:'我们花了两周备课，用瓶盖、吸管、橡皮筋和纸板给全校办了一场科技节。\n\n纸杯传声筒、吸管火箭、橡皮筋动力车、纸桥承重测试……没有3D打印，没有Arduino，但孩子们的眼睛比任何一个科技馆里的城里孩子都亮。\n\n一个一年级女孩在"纸杯电话"里对她最好的朋友说："我听到了！你的声音从绳子那边传过来了！"\n\n科学不是昂贵的仪器。科学是好奇心。而好奇心，山里的孩子一点不比城里少。', author:A2.dapeng,images:['🔬'],teamName:'筑梦支教团',location:'宁夏固原', tags:['科技节','科学教育','低成本','创造力'], comments:[],createdAt:'2026-08-03'},
]
STORIES.push(...S2)

// 追加招募（7条新）
const R2: CommunityRecruit[] = [
  { id:'r9',type:'volunteer_wanted',status:'active', title:'青海海东市民和县急需中学生支教队', content:'海东市民和县官亭镇中心学校急需支教队伍。\n\n【学校情况】初中+小学共800名学生，40%为回族和土族。\n【住宿】提供教师周转房\n【需求】英语、数学、物理、体育\n【特殊需求】有回族志愿者更好（饮食方便）', author:{ id:'g4',name:'民和县教育局',avatar:'🏫',role:'govt',verified:true,badge:'青海海东民和县教育局',location:'青海海东'},region:'青海海东市民和县', tags:['青海','回族','土族','800名学生'],deadline:'2027-06-20', contact:'电话: 0972-XXXXXXX / 工作日8:30-17:30',views:234,createdAt:'2026-08-01'},
  { id:'r10',type:'team_recruit',status:'active', title:'筑梦支教团2027暑期招募—6年深耕陕甘宁', content:'西安交通大学筑梦支教团招募2027暑期队员。\n\n【服务地】宁夏固原、甘肃天水、陕西商洛\n【时长】15-18天\n【招募人数】25-30人\n【特色课程】AI启蒙、科技制作、历史故事、书法\n\n我们坚持"一个支教点至少连续服务5年"的原则。去年的队员今年还可以申请原班人马回访。', author:{...A2.dapeng,role:'official',badge:'筑梦支教团·副队长'},region:'宁夏固原/甘肃天水/陕西商洛', tags:['西安交大','陕甘宁','6年','25-30人'],deadline:'2027-05-31', contact:'公众号: 筑梦支教团 / 邮箱: zhumen@xjtu.edu.cn',views:234,createdAt:'2026-08-01'},
  { id:'r11',type:'material_request',status:'active', title:'青海玉树称多县支教点急需保暖物资', content:'玉树称多县海拔4200米，8月份晚上温度只有5度左右，冬季可达-25度。\n\n急需：保暖睡袋×30、羽绒服×30（6-12岁）、加厚棉被×20、保温杯×50\n\n物资可以直接寄送到称多县教育局。所有接收和使用情况会在支教结束后公示。每件物资都会拍照反馈给捐赠人。', author:{ id:'v10',name:'追光者支教队',avatar:'💫',role:'official',verified:true,badge:'追光者支教队·物资组',location:'青海玉树'},region:'青海玉树称多县', tags:['高寒','保暖物资','睡袋','羽绒服','青海'],deadline:'2026-08-15', contact:'微信: zhuiguangzhe_team / 邮箱: help@zhuiguangzhe.org',views:189,createdAt:'2026-08-02'},
  { id:'r12',type:'volunteer_wanted',status:'active', title:'西藏日喀则市南木林县招募首个支教队伍', content:'南木林县是日喀则地区人口最多的县之一，目前还没有任何支教队伍对接。\n\n【学校】南木林县完全小学，600名学生，80%藏族\n【交通】距日喀则市区2小时车程，距拉萨4小时\n【住宿】学校安排\n【特别说明】有藏语基础的优先，会唱歌跳舞的优先（藏族孩子特别喜欢文艺活动）', author:{ id:'g5',name:'日喀则市教育局',avatar:'🏛️',role:'govt',verified:true,badge:'西藏日喀则市教育局',location:'西藏日喀则'},region:'西藏日喀则南木林县', tags:['西藏','藏族','首个支教队','600名学生'],deadline:'2027-06-01', contact:'电话: 0892-XXXXXXX / 联系人: 普布次仁老师',views:432,createdAt:'2026-08-03'},
  { id:'r13',type:'self_recommend',status:'active', title:'美术专业毕业生，想用画笔记录100个支教瞬间', content:'中国美术学院插画专业应届毕业生，女，24岁。\n\n我不会教书。但我会画画。我希望能去支教队里做"随队画家"——每天用画笔记录课堂上的孩子们、他们的表情、他们的画作、他们的故事。\n\n最后可以把这些画做成一本绘本《100个山里孩子的笑脸》，免费送给支教学校和孩子们。\n\n我的角色不是在教室里教课。我是记录者。\n\n自带画材，自理交通。只要能容下一个人一支笔，哪里都可以。', author:{ id:'p5',name:'小美',avatar:'美',role:'public',verified:false,badge:'中国美术学院·插画专业',location:'浙江杭州'},region:'不限', tags:['画家','记录','绘本','艺术','百张笑脸'], contact:'微信: xiaomei_art2026 / 作品集: xiaomei.artstation.com',views:756,createdAt:'2026-08-03'},
  { id:'r14',type:'team_recruit',status:'active', title:'彩云之南志愿队2027招募—边疆少数民族教育', content:'云南大学彩云之南志愿队招募2027暑期队员。\n\n【服务地】云南西双版纳（傣族）、怒江（傈僳族）、迪庆（藏族）\n【特色项目】民族文化传承工作坊、边疆地理科普、东南亚语兴趣课\n【时长】15天\n【招募】20-25人\n\n我们特别欢迎：会少数民族语言的同学、艺术设计专业、地理/生物专业。不会教书没关系，我们一起学。', author:{...A2.xueli,role:'official',badge:'彩云之南志愿队·队长'},region:'云南西双版纳/怒江/迪庆', tags:['云南','少数民族','傣族','藏族','边疆'],deadline:'2027-05-15', contact:'公众号: 彩云之南志愿队 / 邮箱: caiyun@ynu.edu.cn',views:312,createdAt:'2026-08-03'},
  { id:'r15',type:'material_request',status:'active', title:'河南信阳乡村小学募集教学一体机', content:'信阳市商城县汪桥镇中心小学唯一的投影仪上个月坏了（用了12年的老机器）。现在全校600个孩子上课只能靠黑板和粉笔。\n\n我们希望能募集到1-2台闲置的教学一体机（带触摸屏那种），新旧均可。\n\n学校有技术人员可以安装调试。如果捐赠方在河南省内，学校可以安排车辆上门取。\n\n虽然现在说"多媒体教学"好像很普通，但对这600个孩子来说，看到屏幕亮起来的那一天就是最特别的节日。', author:{...A2.zhang2,role:'official',badge:'汪桥镇中心小学校长'},region:'河南信阳商城县', tags:['教学设备','一体机','河南','600人','多媒体'],deadline:'2026-09-01', contact:'手机: 136XXXX2345 / 学校电话: 0376-XXXXXXX',views:201,createdAt:'2026-08-04'},
]
RECRUITS.push(...R2)

...
export const QUESTIONS: CommunityQuestion[] = [
  ...
  },
  {
    ...
    tags:['留守儿童','心理辅导','情感支持'],
    answers:[
      {id:'a4',content:'不要急着转移注意力或说"别哭了"。先蹲下来抱抱他，等他哭完。然后可以跟他一起画一张"全家福"——画着画着，他会把思念变成画面。也可以让他写一封信给爸爸妈妈，你说你会帮忙寄出去。关键是给思念一个出口。',author:AUTHORS.zhao,likes:672,isAccepted:true,createdAt:'2026-07-25'},
    ],views:603,likes:892,createdAt:'2026-07-25',
  },
  {
    ...
    answers:[
      {id:'a5',content:'树叶拓印课！带孩子捡不同形状的叶子涂颜料印在纸上。石头画课捡圆石头画动物/人脸，成本几乎为零。泥土可以做陶艺——虽然不能烧制但捏泥人本身是最好的美术体验。\n\n筠连当地还有竹子和棕榈叶，可以教孩子做竹编小篮子或棕榈叶蜻蜓，既是美术课也是手工课，顺便介绍本地非遗文化。',author:AUTHORS.yang,likes:356,isAccepted:true,createdAt:'2026-07-26'},
  ...
  },
  {
    ...
    ],views:1890,likes:27,createdAt:'2026-07-27',
  },
  {
...
export const RECRUITS: CommunityRecruit[] = [
  {
    ...
    contact:'微信: fanxing_team / 邮箱: fanxing@uestc.edu.cn / 公众号: 凡星支教',views:12030,createdAt:'2026-08-03',
  },
  {
...
export const STORIES: CommunityStory[] = [
  {
    id:'s1',title:'一个纸箱恐龙，让我看到孩子的无限创造力',likes:892,
  ...
  {
    id:'s2',title:'一个二年级女孩的信，读哭了三个老师',likes:1560,
  ...
  {
    id:'s3',title:'运动会上的"小队长"：10岁男孩的蜕变',likes:672,
...
export const STUDENT_POSTS: StudentSocialPost[] = [
  {
    ...
    image:IMG('student-xiaoyu-dinosaur'),type:'artwork',likes:248,createdAt:'2026-07-22',
  ...
  },
  {
    ...
    image:'🔧',type:'question',likes:152,createdAt:'2026-07-26',
  ...
  },
  {
    ...
    image:'💃',type:'story',likes:356,createdAt:'2026-07-29',
    verifiedBy:'凡星支教队',interestGroup:'音乐之声',
  },
]
...
if (!_initialized) {
  ...
  STORIES.push(
    ...
    { id:'s14',title:'我们不是来"帮助"的——我们是来"学习"的',likes:672, content:'支教结束后很多人问我帮助了多少孩子。我回答不上来。是孩子教我怎么用树叶吹出鸟叫声。是11岁男孩告诉我"读书不是为了离开山里"。他们教会我的，远比我教给他们的多。', author:A2.xueli,images:['🌿'],teamName:'彩云之南志愿队',location:'云南西双版纳', tags:['支教反思','双向成长','公益理念','初心'], comments:[],createdAt:'2026-07-28'},
  ...
  // 追加招募（7条新）
  RECRUITS.push(
    { id:'r9',type:'volunteer_wanted',status:'active', title:'青海海东市民和县急需中学生支教队', content:'海东市民和县官亭镇中心学校急需支教队伍。初中+小学共800名学生，40%为回族和土族。提供教师周转房。需求：英语、数学、物理、体育。', author:{ id:'g4',name:'民和县教育局',avatar:'🏫',role:'govt',verified:true,badge:'青海海东民和县教育局',location:'青海海东'},region:'青海海东市民和县', tags:['青海','回族','土族','800名学生'],deadline:'2027-06-20', contact:'电话: 0972-XXXXXXX',views:2340,createdAt:'2026-08-01'},
    { id:'r10',type:'team_recruit',status:'active', title:'筑梦支教团2027暑期招募—6年深耕陕甘宁', content:'西安交通大学筑梦支教团招募2027暑期队员。服务地：宁夏固原、甘肃天水、陕西商洛。时长15-18天。招募25-30人。特色课程：AI启蒙、科技制作、历史故事、书法。', author:{...A2.dapeng,role:'official',badge:'筑梦支教团·副队长'},region:'宁夏固原/甘肃天水/陕西商洛', tags:['西安交大','陕甘宁','6年','25-30人'],deadline:'2027-05-31', contact:'公众号: 筑梦支教团',views:2340,createdAt:'2026-08-01'},
    { id:'r11',type:'material_request',status:'active', title:'青海玉树称多县支教点急需保暖物资', content:'玉树称多县海拔4200米，8月份晚上温度只有5度左右，冬季可达-25度。急需保暖睡袋×30、羽绒服×30（6-12岁）、加厚棉被×20、保温杯×50。', author:{ id:'v10',name:'追光者支教队',avatar:'💫',role:'official',verified:true,badge:'追光者支教队·物资组',location:'青海玉树'},region:'青海玉树称多县', tags:['高寒','保暖物资','睡袋','羽绒服','青海'],deadline:'2026-08-15', contact:'微信: zhuiguangzhe_team',views:1890,createdAt:'2026-08-02'},
    { id:'r12',type:'volunteer_wanted',status:'active', title:'西藏日喀则市南木林县招募首个支教队伍', content:'南木林县目前还没有任何支教队伍对接。完全小学600名学生，80%藏族。有藏语基础的优先，会唱歌跳舞的优先（藏族孩子特别喜欢文艺活动）。', author:{ id:'g5',name:'日喀则市教育局',avatar:'🏛️',role:'govt',verified:true,badge:'西藏日喀则市教育局',location:'西藏日喀则'},region:'西藏日喀则南木林县', tags:['西藏','藏族','首个支教队','600名学生'],deadline:'2027-06-01', contact:'电话: 0892-XXXXXXX',views:4320,createdAt:'2026-07-29'},
    { id:'r13',type:'self_recommend',status:'active', title:'美术专业毕业生，想用画笔记录100个支教瞬间', content:'中国美术学院插画专业应届毕业生，女，24岁。我想去支教队里做"随队画家"——每天用画笔记录课堂上的孩子们。最后做成绘本《100个山里孩子的笑脸》。自带画材，自理交通。', author:{ id:'p5',name:'小美',avatar:'美',role:'public',verified:false,badge:'中国美术学院·插画专业',location:'浙江杭州'},region:'不限', tags:['画家','记录','绘本','艺术'], contact:'微信: xiaomei_art2026',views:7560,createdAt:'2026-07-29'},
    { id:'r14',type:'team_recruit',status:'active', title:'彩云之南志愿队2027招募—边疆少数民族教育', content:'云南大学彩云之南志愿队招募2027暑期队员。服务地：西双版纳（傣族）、怒江（傈僳族）、迪庆（藏族）。特色项目：民族文化传承、边疆地理科普、东南亚语兴趣课。', author:{...A2.xueli,role:'official',badge:'彩云之南志愿队·队长'},region:'云南西双版纳/怒江/迪庆', tags:['云南','少数民族','傣族','藏族','边疆'],deadline:'2027-05-15', contact:'公众号: 彩云之南志愿队',views:3120,createdAt:'2026-07-27'},
    { id:'r15',type:'material_request',status:'active', title:'河南信阳乡村小学募集教学一体机', content:'信阳市商城县汪桥镇中心小学唯一的投影仪用了12年坏掉了。希望能募集到1-2台闲置的教学一体机（带触摸屏那种），新旧均可。', author:{...A2.zhang2,role:'official',badge:'汪桥镇中心小学校长'},region:'河南信阳商城县', tags:['教学设备','一体机','河南','600人','多媒体'],deadline:'2026-09-01', contact:'手机: 136XXXX2345',views:2010,createdAt:'2026-07-30'},
  )
}

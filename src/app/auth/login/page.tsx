...
export default function LoginPage() {
  ...
  return (<div className="min-h-screen flex items-center justify-center p-6" style={{background:'linear-gradient(135deg,#2E7D32 0%,#4CAF50 40%,#81C784 100%)'}}>
    <Card className="w-full max-w-[400px] border-0 shadow-2xl"><CardContent className="p-8">
      <div className="text-center mb-8"><div className="text-4xl mb-3">🌱</div><h1 className="text-[22px] font-bold text-[var(--text)] tracking-wide" style={{fontFamily:"var(--font-serif)"}}>支教记忆胶囊</h1><p className="text-[12px] text-[var(--text-muted)] tracking-wider mt-1">凡星支教队 · 2026筠连</p></div>

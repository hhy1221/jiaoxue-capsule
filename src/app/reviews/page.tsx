...
export default function ReviewsPage() {
  ...
  return (<InnerLayout>
    <header className="flex items-center justify-between pb-[22px] mb-5 flex-wrap gap-3 relative" style={{borderBottom:'1.5px solid rgba(180,160,130,0.25)'}}>
      ...
      <button className="picture-book-btn primary" style={{fontSize:11}} onClick={()=>setShowForm(true)}>✏️ 写评价</button>
    ...
    <button className="add-new-btn mt-6" onClick={()=>setShowForm(true)}>＋ 写新评价</button>
    <WriteReviewForm open={showForm} onClose={()=>setShowForm(false)} />
  </InnerLayout>)
}
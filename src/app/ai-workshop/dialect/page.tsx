  ...
  return (<InnerLayout>
    ...
    <Tabs defaultValue="translate">
      ...
      <TabsContent value="dictionary">
        ...
        <button className="mt-4 px-4 py-2 rounded-xl border border-dashed border-[var(--border)] text-[var(--text-muted)] text-[12px] tracking-wider bg-transparent cursor-pointer hover:bg-[var(--bg)]">+ 添加方言词汇</button>
      </TabsContent>
    </Tabs></div></InnerLayout>)
}
